1. [Mozilla Developer Network Expressions and Operators](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators)

2. [Mozilla Developer Network Operator Precedence and Associativity](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator_Precedence)

3. [JavaScript Primitive Values](https://developer.mozilla.org/en-US/docs/Glossary/Primitive)

4. [ECMA262 Specification](https://tc39.es/ecma262/)

5. [jQuery Official Website](https://jquery.com/)

6. [React Official Website](https://reactjs.org/)

7. [StackOverflow Developer Survey 2021 Most Popular Technologies](https://insights.stackoverflow.com/survey/2021#technology-most-popular-technologies)

8. [Emojis](http://unicode.org/emoji/charts/full-emoji-list.html#1f600)

https://www.coursera.org/learn/programming-with-javascript/lecture/A0YPr/variables
...
- Video (Conceptual): [Storing data in arrays](https://www.coursera.org/teach/programming-with-javascript/authoringBranch~MLhJZ5FmEe-7jAr_-8_KAQ/content/item/lecture/k1nBb/)
- Video (Mix): [Introduction to objects](https://www.coursera.org/teach/programming-with-javascript/authoringBranch~MLhJZ5FmEe-7jAr_-8_KAQ/content/item/lecture/fRSJ9/)
- Reading: [Arrays are objects](https://www.coursera.org/teach/programming-with-javascript/authoringBranch~MLhJZ5FmEe-7jAr_-8_KAQ/content/item/supplement/QVSrQ)
